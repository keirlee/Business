...
- (id)initWithViewControllers:(NSArray *)vcs imageArray:(NSArray *)arr;
{
	...
	if (self != nil)
	{
		...
		if (IOS7_OR_LATER) {
            CGRect _transitionViewFrame = _transitionView.frame;
            _transitionViewFrame.size.height += 20;
            _transitionView.frame = _transitionViewFrame;
            _tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0, _containerView.frame.size.height - kTabBarHeight+20.0f, 320.0f, kTabBarHeight) buttonImages:arr];
        }else{
